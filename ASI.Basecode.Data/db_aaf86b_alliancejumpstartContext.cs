...
{
    public partial class db_aaf86b_alliancejumpstartContext : DbContext
    {
        public db_aaf86b_alliancejumpstartContext()
        {
        }

        public db_aaf86b_alliancejumpstartContext(DbContextOptions<db_aaf86b_alliancejumpstartContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseLazyLoadingProxies().UseSqlServer("Data Source=SQL9001.site4now.net;Initial Catalog=db_aaf86b_alliancejumpstart;User Id=db_aaf86b_alliancejumpstart_admin;Password=jules0019");
            }
        }
